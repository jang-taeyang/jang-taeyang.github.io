...
<div style="text-align: center; margin-top: 20px; display: flex; flex-direction: column; align-items: center;">
    <img width="780px" class="rounded float-start pe-3" src="../img/essay/cover/Code-Logo.jpg" alt="" style="display: block;">
...
## Code for Role Play <img src="../img/essay/header/checklist.png" width="35px" style="vertical-align: middle; margin-left: 10px;">
...
## First Impressions <img src="../img/essay/header/scale.png" width="45px" style="vertical-align: middle; margin-left: 10px;">
...
<div style="text-align: center; margin-top: 20px; display: flex; flex-direction: column; align-items: center;">
    <img width="580px" src="../img/essay/cover/Code-1.png" alt="" style="display: block;">
...
## Code with Benefits <img src="../img/essay/header/benefits.png" width="35px" style="vertical-align: middle; margin-left: 10px;">
...
## Boosting Code <img src="../img/essay/header/turbo.png" width="45px" style="vertical-align: middle; margin-left: 10px;">
...
## Conclusion <img src="../img/essay/header/Conclusion-Logo.jpg" width="50px" style="vertical-align: middle; margin-left: 10px;">
